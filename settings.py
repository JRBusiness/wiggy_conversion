...
# APP
    ...
    APP_LOG_FORMAT = os.getenv("APP_LOG_FORMAT", "%(asctime)s %(levelname)s %(name)s %(message)s")
    ...
    APP_LOG_STREAM_FORMAT = os.getenv("APP_LOG_STREAM_FORMAT", "%(asctime)s %(levelname)s %(name)s %(message)s")
    APP_LOG_STREAM_DATE_FORMAT = os.getenv("APP_LOG_STREAM_DATE_FORMAT", "%Y-%m-%d %H:%M:%S")
    ...
    APP_LOG_STREAM_BACKTRACE_STYLE = os.getenv("APP_LOG_STREAM_BACKTRACE_STYLE", "darkbg2")
...
# DATABASE
    ...
    DB_POOL_MAX_INACTIVE_CONNECTION_LIFETIME = os.getenv("DB_POOL_MAX_INACTIVE_CONNECTION_LIFETIME", 300)
...
# CELERY
    ...
    CELERY_TASK_DEFAULT_EXCHANGE_TYPE = os.getenv("CELERY_TASK_DEFAULT_EXCHANGE_TYPE", "direct")
...
# SENTRY
    ...
    SENTRY_TRACES_INTEGRATIONS = os.getenv("SENTRY_TRACES_INTEGRATIONS", ["celery", "sqlalchemy"])
    SENTRY_TRACES_SQLALCHEMY_INTEGRATIONS = os.getenv("SENTRY_TRACES_SQLALCHEMY_INTEGRATIONS", True)
    SENTRY_TRACES_CELERY_INTEGRATIONS = os.getenv("SENTRY_TRACES_CELERY_INTEGRATIONS", True)
    SENTRY_TRACES_CELERY_INTEGRATIONS_EXCLUDE = os.getenv("SENTRY_TRACES_CELERY_INTEGRATIONS_EXCLUDE", ["celery.app.trace"])
    SENTRY_TRACES_CELERY_INTEGRATIONS_INCLUDE = os.getenv("SENTRY_TRACES_CELERY_INTEGRATIONS_INCLUDE", [])
